  ...
  return (
    <div className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-2xl md:rounded-3xl shadow-soft border border-white/60 dark:border-neutral-700/60 p-4 md:p-6 min-w-0">
      <div className="flex items-center justify-between pb-4">
        ...
        <span className="text-sm text-neutral-500 dark:text-neutral-400 font-medium flex-shrink-0 ml-2">
          2025
        </span>
      </div>
        ...
        <div className="w-full max-w-xs">
          <div className="grid grid-cols-1 gap-2">
            {categoryPercentages.map((item, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-2.5 bg-neutral-50/80 dark:bg-neutral-700/80 rounded-xl"
              >
                ...
                <span className="text-sm text-neutral-500 dark:text-neutral-400 font-semibold flex-shrink-0 ml-2">
                  {item.percentage}%
                </span>
              </div>
            ))}
