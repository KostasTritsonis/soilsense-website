...
export default function MapReadOnly() {
  ...
  return (
    <div className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-soft flex relative justify-center items-center w-full min-w-0 h-[300px] md:h-[500px] lg:h-[600px] xl:h-[730px] overflow-hidden">
      {isLoading && <LoadingSpinner />}
      <div
        ref={mapContainer}
        className="w-full h-full rounded-xl md:rounded-2xl min-w-0"
      />
    </div>
  );
}
