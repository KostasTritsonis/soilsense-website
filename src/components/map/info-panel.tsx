  ...
  return (
    <div className="flex items-center gap-2 p-2 bg-neutral-50/80 dark:bg-neutral-700/80 rounded-xl">
      <Icon
        ...
        fontSize="small"
      />
      <span className="text-xs md:text-sm text-neutral-600 dark:text-neutral-400 font-medium truncate">
        {label}
      </span>
      <span className="text-xs md:text-sm font-semibold text-neutral-900 dark:text-neutral-300 flex-1 text-right truncate">
        {value}
      </span>
    </div>
  );
...
export default function InfoPanel({
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="p-3 bg-white/95 dark:bg-neutral-800/90 backdrop-blur-sm border border-white/60 dark:border-neutral-700/60 rounded-xl md:rounded-2xl shadow-large sm:shadow-none max-w-[calc(100vw-6rem)] sm:max-w-none">
