...
export default function JobsWidget() {
  ...
  return (
    <div className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-2xl md:rounded-3xl shadow-soft border border-white/60 dark:border-neutral-700/60 p-4 md:p-6 min-w-0">
      <div className="flex items-center justify-between pb-4">
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-10 h-10 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center flex-shrink-0">
            <AccessTime
        ...
        <Link
          href={`/${locale}/jobs`}
          className="flex items-center gap-1 text-sm text-primary-600 dark:text-primary-400 font-medium hover:text-primary-700 dark:hover:text-primary-300 transition-colors flex-shrink-0 ml-2"
        >
      ...
      <div className="space-y-3">
        {sortedJobs?.map((job) => (
          <div
            key={job.id}
            className="p-3 md:p-4 bg-neutral-50/80 dark:bg-neutral-700/80 rounded-xl md:rounded-2xl border border-neutral-100 dark:border-neutral-600/60 hover:bg-neutral-100/80 dark:hover:bg-neutral-600/80 transition-colors"
          >
