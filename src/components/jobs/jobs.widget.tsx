...
export default function JobsWidget() {
  ...
  return (
    <div className="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-sm rounded-3xl shadow-soft border border-white/60 dark:border-neutral-700/60 p-4 md:p-6">
      ...
      <div className="space-y-3">
        {sortedJobs?.map((job) => (
          <div
            key={job.id}
            className="p-4 bg-neutral-50/80 dark:bg-neutral-700/80 rounded-2xl border border-neutral-100 dark:border-neutral-600/60 hover:bg-neutral-100/80 dark:hover:bg-neutral-600/80 transition-colors"
          >
            <div className="space-y-3">
